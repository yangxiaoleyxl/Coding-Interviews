...
```  
对于这个最近公共子节点问题，有两种情况：
- <font color="red"> p, q 本身不是公共子节点  </font> 
- <font color="red"> p, q 中某一个本身就是公共子节点  </font>  

代码思路：
- 若 root == None, 直接返回None 
- <font color="red"> 在前序位置，若 root == value1 or root.val == value2, 直接返回 root </font>
- 递归 root.left，查找是否存在左右子树
- 递归 root.right，查找是否存在左右子树 
- <font color="red"> 在后续位置，若左右节点都不为空，则 </font>
